#include <MC3672.h> // note ORDER MATTERS!!!! this HAS TO BE IN FRONT OF OTHERS...to find this out...add library by using Sketch->Include Library->select the library.

/*Simple Sketch to send accelerometer data through a TCP client socket
...
byte ServerIPAddr [] = {192, 168, 0, 107};//{172,20,10,7};//};//150};
int port             = 5555;
